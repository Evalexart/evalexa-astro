...
skills:
  - tool: "Python"
    icon: "python"
    detail: "Création de bots Discord : fonctions asynchrones, bases de la programmation orientée objet."
  - tool: "SQL"
    icon: "sql"
    detail: "Écriture de requêtes SQL : création de tables, lecture et écriture de données (SQLite et PostgreSQL)."
  - tool: "Web"
    icon: "html5"
    detail: "Conception de la structure, du design et de l'expérience utilisateur du site : navigation bilingue, thèmes clair/sombre, carrousel, accordéon, mise en page responsive."
  - tool: "Hébergement"
    icon: "javascript"
    detail: "Déploiement du site via FTP, gestion du nom de domaine."
  - tool: "Astro"
    icon: "astro"
    detail: "Séparation des composants, gestion des liens traduits, séparation du contenu éditorial bilingue (markdown) et du code."
  - tool: "Apps Script"
    icon: "googleappsscript"
    detail: "Scripts d'automatisations Google Sheets, envoi de données via webhook."
  - tool: "Discord"
    icon: "discord"
    detail: "Gestion de salons, rôles, permissions, webhooks et bots."
  - tool: "Linux"
    icon: "linux"
    detail: "Administration système en ligne de commande, création d'une ISO personnalisée avec Cubic, mise en place de services systemd."
  - tool: "Oracle Cloud"
    icon: "oraclecloud"
    detail: "Création et gestion de serveurs virtuels (VM Always Free), backup, connexion SSH."
  - tool: "Tailscale"
    icon: "tailscale"
    detail: "Réseau privé pour le partage de fichiers et les connexions SSH vers mes VM et entre mes appareils personnels."
